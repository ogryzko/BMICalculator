...
var _user$project$Models$initialModel = {history: _krisajenkins$remotedata$RemoteData$NotAsked, input: _user$project$Models$initialInput, result: _krisajenkins$remotedata$RemoteData$NotAsked};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {history: a, input: b, result: c};
	});
var _user$project$Models$Input = F6(
	function (a, b, c, d, e, f) {
		return {age: a, date: b, gender: c, height: d, weight: e, isSubmitted: f};
	});
var _user$project$Models$HistoryItem = F9(
...
var _user$project$Msgs$OnFetchHistory = function (a) {
	return {ctor: 'OnFetchHistory', _0: a};
};
var _user$project$Msgs$SetGender = function (a) {
	return {ctor: 'SetGender', _0: a};
};
var _user$project$Msgs$Calculate = {ctor: 'Calculate'};
var _user$project$Msgs$Weight = function (a) {
	return {ctor: 'Weight', _0: a};
};
var _user$project$Msgs$Height = function (a) {
	return {ctor: 'Height', _0: a};
};
var _user$project$Msgs$Age = function (a) {
	return {ctor: 'Age', _0: a};
};
var _user$project$Msgs$NoOp = {ctor: 'NoOp'};

var _user$project$CalcInput_Panel$calculateBtn = A2(
	_elm_lang$html$Html$table,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '263'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '73'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '190'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Msgs$Calculate),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Посчитать'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
...
var _user$project$CalcInput_Panel$weight = A2(
	_elm_lang$html$Html$tr,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$id('metricweight'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Вес'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Msgs$Weight),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('кг'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$CalcInput_Panel$height = A2(
	_elm_lang$html$Html$tr,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '50'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Рост'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$td,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '140'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Msgs$Height),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('см'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$CalcInput_Panel$gender = A2(
	_elm_lang$html$Html$tr,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Пол'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Муж.'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Жен.'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$CalcInput_Panel$age = A2(
	_elm_lang$html$Html$tr,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Возраст'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Msgs$Age),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _user$project$CalcInput_Panel$view = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$CalcInput_Panel$age,
						_1: {
							ctor: '::',
							_0: _user$project$CalcInput_Panel$gender,
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$CalcInput_Panel$height,
							_1: {
								ctor: '::',
								_0: _user$project$CalcInput_Panel$weight,
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
			...
			_1: {
				ctor: '::',
				_0: _user$project$CalcInput_Panel$calculateBtn,
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$Commands$fetchHistory = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchHistory,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchHistoryUrl, _user$project$Commands$historyDecoder)));

var _user$project$History_List$historyRow = function (historyItem) {
	return A2(
		_elm_lang$html$Html$tr,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(historyItem.id)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(historyItem.date),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(historyItem.age)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(historyItem.gender)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(historyItem.height)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{ctor: '[]'},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(historyItem.weight)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(historyItem.bmi)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(historyItem.pi)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(historyItem.kind)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$History_List$list = function (historyItems) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				},
				{
													...
													_1: {
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('ИМТ'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Индекс Пондера'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Тип'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$tbody,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$History_List$historyRow, historyItems)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$History_List$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$History_List$list(_p0._0);
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
	}
};
var _user$project$History_List$view = function (response) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$History_List$maybeList(response),
			_1: {ctor: '[]'}
		});
};
		...
		switch (_p0.ctor) {
			...
			case 'Calculate':
				return {
					...
					_1: _user$project$Commands$calculateCmd(model.input)
				};
			case 'SetGender':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{result: _p0._0}),
					_1: _user$project$Commands$fetchHistory
				};
		}
	});
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Результат'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Output_Panel$maybeResult(response),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$View$conditionAndMessageToErrorDiv = function (_p0) {
	var _p1 = _p0;
	return _p1._0 ? A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
...
var _user$project$View$validation = function (input) {
	if (input.isSubmitted) {
		var cond = {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: (_elm_lang$core$Native_Utils.cmp(input.age, 120) < 1) && (_elm_lang$core$Native_Utils.cmp(input.age, 0) > 0),
				_1: 'Пожалуйста, введите возраст от 0 до 120 лет'
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: (_elm_lang$core$Native_Utils.cmp(input.height, 300) < 0) && (_elm_lang$core$Native_Utils.cmp(input.height, 0) > 0),
					_1: 'Пожалуйста, введите рост от 0 до 300 сантиметров'
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: (_elm_lang$core$Native_Utils.cmp(input.weight, 570) < 0) && (_elm_lang$core$Native_Utils.cmp(input.weight, 0) > 0),
						_1: 'Пожалуйста, введите вес от 0 до 570 килограммов'
					},
					_1: {ctor: '[]'}
				}
			}
		...
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, _user$project$View$conditionAndMessageToErrorDiv, cond));
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _user$project$View$viewLeftInput = function (input) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$CalcInput_Panel$view,
			_1: {
				ctor: '::',
				_0: _user$project$View$validation(input),
				_1: {ctor: '[]'}
			}
		});
};
