...
var _user$project$Models$initialModel = {history: _krisajenkins$remotedata$RemoteData$NotAsked, input: _user$project$Models$initialInput};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {history: a, input: b};
	});
...
var _user$project$Commands$fetchHistoryUrl = 'http://localhost:3000/history';
		...
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Date$hour(model.input.date))),
			_1: {
				ctor: '::',
